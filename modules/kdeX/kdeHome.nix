{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-48a4c7a1-c1ee-4612-b171-74510ce4db82" = [ ];
      ...
      "kmix"."decrease-volume-PCM@G935 Gaming Headset" = [ ];
      "kmix"."decrease_microphone_volume" = "Microphone Volume Down";
      "kmix"."decrease_volume" = "Volume Down";
      "kmix"."increase-volume-PCM@G935 Gaming Headset" = [ ];
      "kmix"."increase_microphone_volume" = "Microphone Volume Up";
      "kmix"."increase_volume" = "Volume Up";
      "kmix"."mic_mute" = ["Microphone Mute" "Meta+Volume Mute"];
      "kmix"."mute" = "Volume Mute";
      "kmix"."toggle-mute-PCM@G935 Gaming Headset" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."PreviewSettings"."Plugins" = "audiothumbnail,blenderthumbnail,comicbookthumbnail,djvuthumbnail,ebookthumbnail,exrthumbnail,directorythumbnail,fontthumbnail,marble_thumbnail_geojson,marble_thumbnail_gpx,imagethumbnail,jpegthumbnail,marble_thumbnail_kmz,marble_thumbnail_kml,kraorathumbnail,windowsexethumbnail,windowsimagethumbnail,mltpreview,mobithumbnail,opendocumentthumbnail,marble_thumbnail_osm,palathumbcreator,gsthumbnail,rawthumbnail,svgthumbnail,ffmpegthumbs,webarchivethumbnail";
      "dolphinrc"."Search"."Location" = "Everywhere";
      "kactivitymanagerdrc"."activities"."48a4c7a1-c1ee-4612-b171-74510ce4db82" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "48a4c7a1-c1ee-4612-b171-74510ce4db82";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{b8f8cfca-457f-46b9-ac5d-727d73153dae}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{633845df-c3b4-4df0-9eb4-b61b0956120e}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{614a6769-370c-4710-b4ad-bbd4fe9ebe08}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{1b654064-c46f-4245-9343-274cfb4b70ab}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{696c06e3-66c7-41db-8667-eb0179b97ed6}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{b49fd8c5-b969-4768-b1a2-51fbfccb41a6}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{e7c4d87a-a80d-4a1b-bb5f-15982fe04693}";
      ...
      "kmixrc"."Configure"."Height 1080" = 442;
      "kmixrc"."Configure"."Width 1920" = 598;
      ...
      "kmixrc"."Global"."Position" = "2672,312";
      "kmixrc"."Global"."Size" = "478,448";
      ...
      "kmixrc"."View.PulseAudio.Capture_Devices.1.default.PulseAudio::Capture_Devices:1.alsa_input.pci-0000_1a_00.6.analog-stereo"."Split" = false;
      "kmixrc"."View.PulseAudio.Capture_Devices.1.default.PulseAudio::Capture_Devices:1.alsa_input.usb-Logitech_G935_Gaming_Headset-00.mono-fallback"."Split" = false;
      "kmixrc"."View.PulseAudio.Playback_Devices.1.default.PulseAudio::Playback_Devices:1.alsa_output.pci-0000_1a_00.6.analog-stereo"."Split" = false;
      "kmixrc"."View.PulseAudio.Playback_Devices.1.default.PulseAudio::Playback_Devices:1.alsa_output.usb-Logitech_G935_Gaming_Headset-00.analog-stereo"."Split" = false;
      "kmixrc"."View.PulseAudio.Playback_Devices.1.default.PulseAudio::Playback_Devices:1.auto_null"."Split" = false;
      ...
      "kmixrc"."View.PulseAudio.Playback_Streams.1.default.PulseAudio::Playback_Streams:1.stream:2730"."Split" = false;
      "kmixrc"."View.PulseAudio.Playback_Streams.1.default.PulseAudio::Playback_Streams:1.stream:3763"."Split" = false;
      ...
      "kservicemenurc"."Show"."PalapeliImport" = true;
      "kservicemenurc"."Show"."Play" = true;
      "kservicemenurc"."Show"."WriteCdImage" = true;
      "kservicemenurc"."Show"."addToCollection" = true;
      "kservicemenurc"."Show"."akregatorplugin" = true;
      ...
      "kwinrc"."Desktops"."Id_1" = "cd331236-dc48-4c8c-a5ed-3bd64864c7c9";
      ...
      "kwinrc"."Tiling.03209fed-4c1d-5a13-8d69-9940e6d6136d"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.20a308b6-870c-5e34-ac24-85a86ab02443"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.21df4e9b-6bb2-5db9-87fa-a757afb61477"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.484c1594-8d79-5944-aa8d-51e491a1ba7a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling.5aed48eb-5f5f-5626-83d2-b9c5cffe0545"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling.61cf355d-3ddd-59a6-8bb4-b317ed5ecdb6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.63f3f4a4-c9bf-50ee-9a16-0b663d235279"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.6d432eea-7ddb-553b-a9aa-064dbc6854b1"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.6d469f64-ca43-5c42-b967-9d17574862d2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.81557ead-9f00-5b57-ae42-69b09a62dea0"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.90574bb0-0d5c-5030-9f2f-9de66a76ca6b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.9227bb3e-de3c-5d37-8247-1baf6014a581"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.959c5302-437c-5990-9fd4-c3b4458a4393"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.9d7f036e-c5b5-5b67-9510-cc4efb36d4d2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.9f5f61de-3e16-5c36-94c0-2f2ccbe788e7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.b9f425ff-a427-54e8-9272-0f5dd5375a46"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.c1bcbcbe-90fb-5552-aee9-b92390b5bea8"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.c9be2b55-bed2-59f5-b1f0-2108d007aab3"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.daf3e5c6-bf28-50e4-adf3-dcceca7b5839"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
